...
import 'package:velotoulouse/ui/screens/map/map_content.dart';
...
class MapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<StationViewModel>(create: (context) => StationViewModel(stationRepository: context.read<StationRepository>())),
